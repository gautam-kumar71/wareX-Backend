...
public class SecurityConfig {
    ...
    // ── Inline JWT filter — no Auth Service dependency ─────────────────────
    // The Warehouse Service validates JWT tokens using the shared secret.
    // It does NOT call the Auth Service over HTTP for every request.
    // This is stateless and performant.
        ...
        protected void doFilterInternal(HttpServletRequest request,
            ...
            if (token != null) {
                try {
                    ...
                    log.debug("JWT validation failed in warehouse-service: {}", ex.getMessage());
