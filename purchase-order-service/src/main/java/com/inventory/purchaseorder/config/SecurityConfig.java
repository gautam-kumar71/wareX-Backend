...
public class SecurityConfig {
    ...
    static class JwtValidationFilter extends OncePerRequestFilter {
        ...
        protected void doFilterInternal(HttpServletRequest request,
            ...
            // Prefer X-User-Id header injected by API Gateway (internal calls)
            String userId = request.getHeader("X-User-Id");
            String role   = request.getHeader("X-User-Role");

            if (userId != null && role != null) {
                // Gateway already validated — trust the headers
            ...
            // Fallback: validate JWT directly (direct calls bypassing gateway)
